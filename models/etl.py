...
def format_transcript(transcript:list, video_id:str, video_title:str, 
                      batch_size:int=None, 
                      overlap:int=None) -> List[Dict[str, Dict[str, str, str, str]]]:
...
@timeit
def run_etl(json_path:str=MAIN_VIDEOS_JSON_PATH, db:str=None, 
            batch_size:int=None, overlap:int=None) -> None:
